...
/**
 * Created by prasanth on 8/30/2016.
 */
public class ListTaskConversationFiles {
    int id;
    private ListFromDetails user;
    String  fileSource;
    String  fileSourceId;
    String  fileType;
    String  fileName;
    ...
    public ListFromDetails getUser() {
        return user;
    }

    public void setUser(ListFromDetails user) {
        this.user = user;
    }
