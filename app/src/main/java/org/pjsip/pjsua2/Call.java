...
public class Call {
  ...
  protected Call(long cPtr, boolean cMemoryOwn) {
    Log.i("SipVideo", "Constructor Call :  cPtr : " + cPtr + " cMemoryOwn : " + cMemoryOwn);
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
    Appreference.call_swigCPtr.put(cPtr,this);
  }
  ...
  protected void finalize() {
    Log.i("SipVideo", " delete: b3" );
    delete();
  }

  public synchronized void delete() {
    Log.i("SipVideo", " delete: "+swigCPtr +" swigCMemOwn :"+swigCMemOwn+" Appreference.call_swigCPtr.size() : "+Appreference.call_swigCPtr.size());
    if(Appreference.call_swigCPtr.containsKey(swigCPtr)) {
      Log.i("SipVideo","Appreference.call_swigCPtr.containsKey if");
      Appreference.call_swigCPtr.remove(swigCPtr);
    } else {
      Log.i("SipVideo","Appreference.call_swigCPtr.containsKey else");
    }
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        Log.i("SipVideo", " pjsua2JNI.delete_Call 0" );
        pjsua2JNI.delete_Call(swigCPtr);
      }
      Log.i("SipVideo", "After pjsua2JNI.delete_Call "+swigCPtr );
      swigCPtr = 0;
    }
  }
  ...
  protected void swigDirectorDisconnect() {
    swigCMemOwn = false;
    Log.i("SipVideo", " delete: b4");
    delete();
  }

  public void swigReleaseOwnership() {
    Log.i("changehost","swigReleaseOwnership");
    swigCMemOwn = false;
    pjsua2JNI.Call_change_ownership(this, swigCPtr, false);
  }

  public void swigTakeOwnership() {
    Log.i("changehost","swigTakeOwnership");
    swigCMemOwn = true;
  ...
  public void makeCall(String dst_uri, CallOpParam prm) throws Exception {
    Log.d("PJSUA2","inside makeCall------>"+dst_uri+""+prm.toString());
    Log.i("VideoCallLogs", "make call  dst_uri  prm.toString(): " + dst_uri+""+prm.toString());
  ...
  public void onCallState(OnCallStateParam prm) {
    Log.d("SipVideo","inside onCallState created------>"+prm);
  ...
  public void onCallSdpCreated(OnCallSdpCreatedParam prm) {
    Log.d("PJSUA2","inside oncallsdp created------>"+prm+swigCPtr+conf_id);
