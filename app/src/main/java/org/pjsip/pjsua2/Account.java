...
public class Account {
  ...
  public void setOnlineStatus(PresenceStatus pres_st) throws Exception {
	  Log.i("SipVideo", "came to setOnlineStatus" +pres_st.getStatus() +" note Txt" + pres_st.getNote() + " get activity" + pres_st.getActivity());
  ...
  public void onIncomingSubscribe(OnIncomingSubscribeParam prm) {
    Log.i("subscribe","Accout class onInComingSubscribe");
    Log.i("subscribe","Accout class onInComingSubscribe from uri-->"+prm.getFromUri());
