...
//			inflater.inflate(R.layout.datetimepicker, this, true);
    ...
    private void initFilterNumericDigit() {
        ...
        try {
            date_display.setFilters(new InputFilter[] { new InputFilterMinMax(
                    01, cal.getActualMaximum(Calendar.DAY_OF_MONTH)+1) });
            Log.i("Datetimepicker","inside initFilterNumericDigit");
            ...
            hour_display.setFilters(new InputFilter[] { new InputFilterMinMax(
                    0, 23) });
            min_display.setFilters(new InputFilter[] { new InputFilterMinMax(00, 59) });
        } catch (Exception e) {
    ...
    private void changeFilter() {
        try {
            ...
            date_display.setFilters(new InputFilter[] { new InputFilterMinMax(
                    01, cal.getActualMaximum(Calendar.DAY_OF_MONTH)+1) });
            Log.i("Datetimepicker","inside changeFilter");
        } catch (Exception e) {
