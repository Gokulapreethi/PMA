...
/**
 * Created by Preethi on 12-06-2017.
 */


public class CommonDateTimePicker extends RelativeLayout {
        ...
        // Constructor start
        public CommonDateTimePicker(Context context) {
            this(context, null);

            init(context);
        }
        public CommonDateTimePicker(Context context, AttributeSet attrs) {
            this(context, attrs, 0);
        }

        public CommonDateTimePicker(Context context, AttributeSet attrs, int defStyle) {
