...
//        ArrayList<TaskDetailsBean> arrayList = new ArrayList<>();
    ...
    public String getAlertShownstatus(String alertQuery) {
        String result_value ="";
        Cursor cur;
        try {
            if (db == null)
            ...
            try {
                if (db != null) {
                    ...
                    cur.moveToFirst();
                    while (!cur.isAfterLast()) {
                        result_value = cur.getString(cur.getColumnIndex("taskPlannedLatestEndDate"));
                        cur.moveToNext();
                    }
                    cur.close();
                }
